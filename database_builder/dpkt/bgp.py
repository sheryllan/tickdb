...
if __name__ == '__main__':
    ...
    class BGPTestCase(unittest.TestCase):
        def testPack(self):
            b1 = BGP(self.bgp1)
            self.assertTrue(self.bgp1 == str(b1))
            b2 = BGP(self.bgp2)
            self.assertTrue(self.bgp2 == str(b2))
            b3 = BGP(self.bgp3)
            self.assertTrue(self.bgp3 == str(b3))
            b4 = BGP(self.bgp4)
            self.assertTrue(self.bgp4 == str(b4))
        ...
        def testUnpack(self):
            ...
            self.assertTrue(r.prefix == '\xc0\xa8\x04\x00')
            ...
            self.assertTrue(c.data == '\x00\x01\x00\x01')
