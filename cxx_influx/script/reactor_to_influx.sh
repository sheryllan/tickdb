...
export REACTOR_SOURCE_FILE=../config/product_to_colo_src.csv
...
export POST_INFLUX_THREAD_COUNT=4
...
export PRODUCT_NAMES='N225,MN,N225W,JGB,TOPIX,TOPIXMINI,JP400'

export LOG_FILE=/mnt/tank/home/ylei/tmp/reactor2influx`date +%Y-%m-%dT%H:%M:%S`.log
