...
{
public:
    using Processed_Files = std::unordered_map<int32_t/*date*/, std::unordered_set<std::string>>;
    static void get_processed_files(Processed_Files&, const std::string& http_host_, uint16_t http_port_
                                  , const std::string& influx_db_, Date_Range);
    static void update_processed_files(const Processed_Files&, const std::string& http_host_, uint16_t http_port_
                                     , const std::string& influx_db_);
